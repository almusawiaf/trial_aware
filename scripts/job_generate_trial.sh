...
#SBATCH --cpus-per-task=16               # CPU cores (evaluation needs modest compute)
#SBATCH --mem=256G                       # Memory (adjust if evaluating millions of nodes)
#SBATCH --time=3-02:00:00                 # Time limit (2 hours is usually plenty)
...
python data_pipeline/load_1000_trials.py
